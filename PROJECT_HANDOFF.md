...
- Proposed catalog fields, verified from the two public ZIPs: `6_fields_of_isis` needs `game_version: "3"` and `content_sha256: "7ced89b270736347849029408f8917d55f4fea0177925e28b25298ba4ed98926"`; `xxx_survival` needs `game_version: "3"` and `content_sha256: "774a02a00ab4fd6196a582968e596c7175b86cc2415ee275d94874babd331dbb"`. These are proposed data edits, not yet published.
...
First, correct the two legacy public map records by adding `game_version: "3"` and each package's verified `content_sha256`, while preserving their existing release labels. Review the exact catalog diff and publish it through the authorized COS workflow. A catalog item without a content fingerprint cannot prove that an edited same-version local folder matches the cloud package; automatic sync deliberately leaves that folder alone. Run a supervised sync with a small test library after the catalog correction.
